...
frame_baixo= Frame(janela, width=295, height=300, background=co0, pady=0, padx=0, relief='flat')
...
def calcular():
    ...
    if resultado < 18.5:
        ...
        l_resultado_texto['text']= "Você está com PESO normal!"
    elif resultado >= 25 and resultado < 30:
        l_resultado_texto['text']= "Você está SOBREPESO!"
    elif resultado >= 30 and resultado < 40:
        l_resultado_texto['text']= "Você está OBESO!"
    else:
        l_resultado_texto['text']= "Você está com OBESIDADE MORBIDA, CUIDADO!!"
...
l_resultado_texto= Label(frame_baixo, text='', width=37, height=1, padx=0, pady=20, relief='flat', anchor='center', font='ivy 10 bold',bg=co0, fg=co1)
l_resultado_texto.place(x=0, y=90)

b_calcular= Button(frame_baixo, command=calcular, text='Calcular', width=35, height=1, border=0, overrelief=SOLID, relief='raised', anchor='center', font='ivy 10 bold',bg=co2, fg=co0)
